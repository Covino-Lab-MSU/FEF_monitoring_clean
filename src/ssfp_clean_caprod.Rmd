...
author: "Adapted for FEF SSFP by LKremer"
date: "10/15/2021"
...
opn_concat <- function(interfiles, year, location, site) {
   file_path <- paste(interfiles, year, location, site, sep='/')
   ...
   data <- lapply(path_list, function(x) {
      ...
      dat$rod_no <- unlist(strsplit(x, "_"))[4]
      return(dat)
   })
...
stage_raw <- opn_concat(interfiles, year, location, site)
...
```
#dh1
#bad_id <- c(1:13, 1869:1874, 2876:2880, 4030:4034, 4897:4901, 5171:5177, 6912:6915, 9201:9207, 9943:9945, 14121:14127, 15139:15142, 17720:21201)
