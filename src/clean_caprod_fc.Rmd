...
Functions that open and concatonate formatted data files
...
```{r, fig.align = "center", fig.cap = "Figure 1.1.6: Adjusted stage data from Fool 1 which includes a manual offset that adjusts all values in the dataframe. "}
manual_offset <- 25
# fc1 = 
# fc2 = 0
stage_adj <- stage_adj%>%
...
```{r chktempfc2r_20, fig.align = "center", fig.cap = "Figure 1.2.2: Air temperature data captured by the capacitance rod Fool 2 in 2020.", echo=FALSE}
...
```{r plantflagsfc2, fig.align = "center", fig.cap = "Figure 1.2.1: Raw data for Fool 2 stage in 2020.", echo=FALSE}
...
```{r plot1fc3, fig.align = "center", fig.cap = "Figure 1.3.1: Raw data for Fool 3 stage in 2020.", echo=FALSE}
...
```{r checktime2fc3, echo=FALSE, results = 'asis'}
cat(paste0(
  "- `", 'The number of missing timesteps is ', length(miss_ts), "`", sep = "\n"))
...
#### Plot adjusted stage
```{r plot2fc3_2020, fig.align = "center", fig.cap = "Figure 1.3.4: Same as 3.4 but limited to adjusted values only.", echo=FALSE}
...
Plot adjusted values only:
```{r plot5fc3_20, fig.align = "center", fig.cap = "Figure 1.3.5: Same as 1.4 but limited to adjusted values only.", echo=FALSE}
dyStageAdjonly<- function(df= stageAdj,max=1200){
      tsStageAdj<- xts(dplyr::select(df, datetime, adj_wtr_ht,ID), order.by=df$datetime)
      dygraph(tsStageAdj) %>% 
            dyAxis('y',label='mm',valueRange = c(0, 300))%>%
...
```{r plot1fc4, fig.align = "center", fig.cap = "Figure 1.4.1: Raw data for Fool 4 stage in 2020.", echo=FALSE}
#quick plot of stage
...
```{r checktime2fc4, echo=FALSE, results = 'asis'}
cat(paste0(
  "- `", 'The number of missing timesteps is ', length(miss_ts), "`", sep = "\n"))
...
Plot adjusted values only:
```{r plot4fc1, fig.align = "center", fig.cap = "Figure 2.1.5: Same as 1.4 but limited to adjusted values only.", echo=FALSE}
...
Plot adjusted values only:
```{r plot3fc2_21, fig.align = "center", fig.cap = "Figure 2.2.5: Same as 2.2.4 but limited to adjusted values only.", echo=FALSE}
...
Plot adjusted values only:
```{r plot3fc3_21, fig.align = "center", fig.cap = "Figure 2.3.5: Same as 3.4 but limited to adjusted values only.", echo=FALSE}
...
Plot adjusted values only:
```{r plot3fc1_22, fig.align = "center", fig.cap = "Figure 3.1.5: Same as 3.1.4 but limited to adjusted values only.", echo=FALSE}
