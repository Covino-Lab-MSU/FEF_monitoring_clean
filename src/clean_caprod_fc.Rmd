...
```{r badidfc1_21}
#fool2
bad_id_fc2_2021 <- c(1174:1178)

#fool2
vert_correction_fc2_2021<- data.frame(ID = c(8175:8186), offset=c(0))%>%
  mutate(cumOffset = cumsum(offset))
  
bad_id <- bad_id_fc2_2021
vert_correction <- vert_correction_fc2_2021
```
...
```{r badidfc2_21}
#fool2
bad_id_fc2_2021 <- c(1174:1179, 4288:4293, 11104:11109)

#fool2
vert_correction_fc1_2021<- data.frame(ID = c(8175:8176), offset=c(0))%>%
  mutate(cumOffset = cumsum(offset))
