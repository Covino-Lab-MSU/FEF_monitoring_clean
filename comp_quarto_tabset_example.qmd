...
fig.cap <-  paste('Figure watershed_1. ', year, ' - ', cap.site.label, '.all: Raw data for all HOBO water level loggers in the ', cap.site.label, ' transect - ', year, '.', sep ='')
```
...
fig.cap <-  paste("Figure transect_1.", year, " - ", cap.site.label, ".", abbr, ": Air temperature data captured by the HOBO water level logger monitoring ", posit_nm, " pressure in ", cap.site.label, " - ", year, ".", sep = '')
```
...
fig.cap1 <-  paste("Figure transect_2a. ", year, " - ", cap.site.label, ".", abbr, ": Raw pressure data from ", cap.site.label, " ", year, " with flags where stage changes by more than 5% in a single timestep. No flags identified in raw atmospheric data.", sep = '')

fig.cap2 <-  paste("Figure transect_2b. ", year, " - ", cap.site.label, ".", abbr, ": Raw pressure data from ", cap.site.label, " ", year, " with cummulative precipitation in 10 minute intervals.", sep = '')
```
...
DyRawPress(df=press_raw_atms, threshold = 0.05, min = min(press_raw_atms$pressure_kPa)-5, max = press_raw_atms$pressure_kPa +10)
```
...
DyRawPP(plot_df, threshold = 0.05, min = min(press_raw_atms$pressure_kPa)-5, max = press_raw_atms$pressure_kPa +10)
```
...
```{r, echo=FALSE}
fig.cap <-  paste("Figure transect_3.", year, " - ", cap.site.label, ".", abbr, ": Pressure reported by ", cap.site.label, " ", posit_nm, " logger.", sep = '')
...
fig.cap <-  paste('Figure transect_1. ', year, ' - ', cap.site.label,'.', abbr, ': Air temperature data captured by the HOBO water level logger monitoring pressure in the ', long_nm, ' (', abbr, ') ', cap.site.label, ' - ', year, '.', sep = '')
```
...
```{r, include=FALSE}
fig.cap1 <-  paste("Figure transect_2a. ", year, " - ", cap.site.label, ".", abbr, ": Raw pressure data from the ", cap.site.label, " ", long_nm, ' in ',  year, " with flags where stage changes by more than 5% in a single timestep. No flags identified in raw atmospheric data.", sep = '')

fig.cap2 <-  paste("Figure transect_2b. ", year, " - ", cap.site.label, ".", abbr, ": Raw pressure data from the ", cap.site.label, " ", long_nm, ' ', year, " with cummulative precipitation in 10 minute intervals.", sep = '')
```
...
DyRawPress(df=stage_well, threshold = 0.05, min = min(stage_well$pressure_kPa)-5, max = stage_well$pressure_kPa +10)
```
...
DyRawPP(plot_df, threshold = 0.05, min = min(stage_well$pressure_kPa)-5, max = stage_well$pressure_kPa +10)
```
...
```{r, echo=FALSE}
fig.cap <-  paste("Figure transect_3. ", year, " - ", cap.site.label, ".", abbr, ": Raw stage data from the ", cap.site.label, ' ', long_nm, "  in ", year, " with flags where average stage changes by more than 5% in a single timestep", sep = '')
```
...
#Raw stage plot
DyRawStage(df=stage_well, threshold = 0.05, min = min(stage_well$hobo_wtr_depth_cm)-5, max = stage_well$hobo_wtr_depth_cm +10)
```
...
```{r, echo=FALSE}
fig.cap <-  paste("Figure transect_4. ", year, " - ", cap.site.label, ".", abbr, ": Adjusted stage data from ", cap.site.label, ' ', long_nm, "  in ", year, " with cumulated precipitation in 10 minute invervals", sep = '')
```
...
dyStageAdjonly(df=plot_df, min = min(stage_adj$adj_stage)-5, max = stage_adj$adj_stage +10)
```
...
```{r}
fig.cap <-  paste("Figure transect_5. ", year, " - ", cap.site.label, ".", abbr, ": Difference between sensor measured water depth and manual depth measurement ", cap.site.label, ' ', long_nm, "  in ", year, ".", sep = '')
```
...
#Raw stage plot
DyRawStage(df=stage_well, threshold = 0.05, flag='TRUE', min = min(stage_well$hobo_wtr_depth_cm)-5, max = stage_well$hobo_wtr_depth_cm +10)
```
...
```{r, echo=FALSE}
fig.cap <-  paste('Figure watershed_2. ', year, ' - ', cap.site.label, ".all: Adjusted stage data for all transects within the ", cap.site.label, " watershed in ", year, '.',  sep = '')
```
